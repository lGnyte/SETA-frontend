...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error("Error registering: " + (err instanceof Error && err.message))
        } finally {
            setIsLoading(false)
        }
    }
    ...
    return (
        <div className="mt-8 sm:mt-16 md:mt-20 text-center w-full">
            <h1 className="mb-10 text-4xl sm:text-5xl mx-4 font-bold inline-block border-b-4 border-primary">Create a New Account</h1>
            <div className="max-w-[400px] mx-4 xs:ml-auto xs:mr-auto flex flex-col items-center bg-white rounded-lg shadow-lg py-2 px-10">
