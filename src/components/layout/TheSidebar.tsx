...
export default function TheSidebar(props: { show: boolean, close: () => void}) {
    ...
    return (
        <div className={`lg:w-[300px] md:w-[250px] w-[calc(100vw-16px)] m-2 md:my-4 md:ml-4 md:mr-0 md:rounded-r-none rounded-2xl md:static p-3 lg:p-5 border-2 shadow-xl bg-white flex-col ${show ? "flex absolute" : "md:flex hidden absolute"}`}>
